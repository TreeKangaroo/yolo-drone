...
then
    ...
    LOCAL_STATE_SERVER_PORT=$LOCAL_STATE_SERVER_PORT
    ...
    #nohup /usr/bin/socat UDP4-LISTEN:8891,fork UDP4:$DOCKER_VETH_HOST_IP:8890,bind=:8891 &>/dev/null &
    ...
    #nohup /usr/bin/socat UDP4-LISTEN:8889,fork UDP4:$DRONE_IP:8889 &>/dev/null &
    #nohup /usr/bin/socat UDP4-LISTEN:8890,fork UDP4:$DRONE_IP:8890 &>/dev/null &
    nohup socat UDP4-LISTEN:8890,fork,reuseaddr UDP4:172.17.0.1:$LOCAL_STATE_SERVER_PORT &>/dev/null &
    nohup socat UDP4-LISTEN:8809,fork,reuseaddr UDP4:192.168.10.1:8889 &>/dev/null &
    nohup socat UDP4-LISTEN:11111,fork,reuseaddr UDP4:172.17.0.1:$LOCAL_VID_SERVER_PORT &>/dev/null &
