...
then
    ...
    nohup /usr/bin/socat UDP4-LISTEN:8889,fork UDP4:192.168.10.1:8889,bind=:8889 &>/dev/null &
    nohup /usr/bin/socat UDP4-LISTEN:8890,fork UDP4:192.168.10.1:8890,bind=:8890 &>/dev/null &
