...
def parse_args():
    ...
    parser.add_argument('--drone_ap', dest='DRONE_AP',
                        ...
                        '[retrieved from config.ini]',
                        type=str, default='')
    parser.add_argument('--local_state_server_port', dest='LOCAL_STATE_SERVER_PORT',
...
def merge_args(cfg, args):
    ...
    for key in ('CONTAINER_NAME', 'WIFI_DEV', 'DRONE_AP',
                'LOCAL_STATE_SERVER_PORT', 'LOCAL_VID_SERVER_PORT'):
...
def dispatcher():
    ...
    config_path = os.path.join(os.getcwd(), 'config2.ini')
    ...
    if args.task == 'build':
        ...
        local_state_server_port = cfg['Session']['LOCAL_STATE_SERVER_PORT']
        ...
        cmds.append(['docker', 'run',
                     ...
                     '--env', 'LOCAL_STATE_SERVER_PORT='+local_state_server_port,
