...
class Tello:
    ...
    def __init__(self,
                 host=TELLO_IP, state_port=STATE_UDP_PORT, video_port=VS_UDP_PORT, control_port=CONTROL_UDP_PORT,   retry_count=RETRY_COUNT):
        
        Tello.TELLO_IP=host
        Tello.STATE_UDP_PORT=state_port
        Tello.VS_UDP_PORT=video_port
